...
if __name__ == '__main__':
    ...
    parser.add_option("--dialect",  default="bronberg", help="MAVLink dialect")
    ...
    parser.add_option("--default-modules", default="ftap_arm,log,cmdlong,battery,calibration,rc,mode",help='default module list')
